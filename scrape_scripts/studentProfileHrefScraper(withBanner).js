...
async function playTest(url) {
  ...
  await page.waitForXPath(
    `//*[@id="main"]/div/div/div[3]/ul/li[1]/div/div/div[2]/div[1]/div/div[1]/span/div/span[1]/span/a/span/span[1]`
  );
  let totalArr = [];
    ...
    for (j = 1; j <= 10; j++) {
      let name =
        document.querySelectorAll(
          ...
          `#main > div > div > div:nth-child(3) > ul > li:nth-child(${j}) > div > div > div.entity-result__content.entity-result__divider.pt3.pb3.t-12.t-black--light > div.mb1 > div > div.t-roman.t-sans > span > div > span.entity-result__title-line.flex-shrink-1.entity-result__title-text--black > span > a`
        )[0] &&
        document.querySelectorAll(
          `#main > div > div > div.pv2.artdeco-card.ph0.mb2 > ul > li:nth-child(${j}) > div > div > div.entity-result__content.entity-result__divider.pt3.pb3.t-12.t-black--light > div.mb1 > div > div.t-roman.t-sans > span > div > span.entity-result__title-line.flex-shrink-1.entity-result__title-text--black > span > a > span > span:nth-child(1)`
        )[0].innerText;
      ...
      let link = document.querySelectorAll(
        // `#main > div > div > div.pv2.artdeco-card.ph0.mb2 > ul > li:nth-child(${j}) > div > div > div.entity-result__content.entity-result__divider.pt3.pb3.t-12.t-black--light > div.mb1 > div > div.t-roman.t-sans > span > div > span.entity-result__title-line.flex-shrink-1.entity-result__title-text--black > span > a`
        `#main > div > div > div:nth-child(3) > ul > li:nth-child(${j}) > div > div > div.entity-result__content.entity-result__divider.pt3.pb3.t-12.t-black--light > div.mb1 > div > div.t-roman.t-sans > span > div > span.entity-result__title-line.flex-shrink-1.entity-result__title-text--black > span > a`
      )[0].href;
